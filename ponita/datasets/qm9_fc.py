...
if __name__ == '__main__':
    ...
    batch_size = 96
    dataset = QM9DatasetFC(target='alpha', split='train')
    dataloader = DataLoader(dataset, batch_size=batch_size, shuffle=False, pin_memory=True, collate_fn=collate_fn_fc, num_workers=0)
